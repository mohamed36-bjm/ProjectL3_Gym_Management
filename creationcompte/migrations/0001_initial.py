    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificat', models.FileField(blank=True, null=True, upload_to='certificates/')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coach_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Inscription',
            fields=[
                ...
                ('seance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inscriptions', to='creationcompte.seance')),
            ],
        ),
    ]
